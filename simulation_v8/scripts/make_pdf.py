...
MD=os.path.join(HERE,"report_sim_v8.md");FIG=os.path.join(HERE,"figures")
...
for fig in sorted(glob.glob(os.path.join(FIG,"*.png"))):
    ...
    pdf.ln(3)
out=os.path.join(HERE,"report_sim_v8.pdf");pdf.output(out);print("PDF:",out,os.path.getsize(out))
